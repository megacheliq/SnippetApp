...
const EditForm: React.FC<EditFormProps> = ({ fetchSnippets, snippet }) => {
    ...
    const form = useForm<z.infer<typeof formSchema>>({
        ...
        defaultValues: {
            ...
            mainQuestion: snippet.mainQuestion,
            solution: snippet.solution,
            additionalQuestions: snippet.additionalQuestions.map(question => ({ value: question }))
        },
    });
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        ...
        const response = await updateSnippet(formattedValues as ICommandDto, snippet.id);
        if (response) {
